...
namespace CubicVR {
    ...
    class transform {
        ...
        void translate(__float x, __float y, __float z) {
            ...
            m_stack[c_stack] = mat4::multiply(m_stack[c_stack],m);
            if (valid == c_stack && c_stack) {
                valid--;
            }
        }
        ...
        void rotate(__float ang, __float x, __float y, __float z) {
            ...
            if (x) {
                ...
                m_stack[c_stack] = mat4::multiply(X_ROT,m_stack[c_stack]);
            }
            ...
            if (y) {
                ...
                m_stack[c_stack] = mat4::multiply(Y_ROT,m_stack[c_stack]);
            }
            ...
            if (z) {
                ...
                m_stack[c_stack] = mat4::multiply(Z_ROT,m_stack[c_stack]);
            }
